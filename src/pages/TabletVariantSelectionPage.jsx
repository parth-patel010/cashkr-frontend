          ...
          <div className="flex flex-col md:flex-row gap-8 lg:gap-12 p-5 sm:p-8 lg:p-10">
            <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <div className="flex items-center justify-center md:justify-start gap-1 text-amber-400 mb-3">
                ...
                <span className="text-gray-900 font-bold ml-2 text-sm">
                  4.8 <span className="text-gray-400 font-medium">(150+ Reviews)</span>
                </span>
              </div>
            ...
            <div className="flex-1 w-full">
              ...
              <p className="text-sm font-semibold text-gray-500 mb-5">
                1,500+ Devices Sold Successfully
              </p>
              ...
              <Button
                ...
                onClick={() =>
                  navigate(
                    `/sell-tablet/${brand}/${slug}/quiz?storage=${selectedVariant.storage}`,
                  )
                }
              >
                Start Selling
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-amber-700 leading-relaxed">
                      You can check your storage in Settings &gt; General &gt; iPad Storage (for
                      iPads) or Settings &gt; Storage (for Android tablets).
                    </p>
                  </div>
                </div>
              </div>
